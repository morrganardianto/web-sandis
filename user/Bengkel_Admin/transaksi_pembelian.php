...
<?php include "navigasi.php";
      include "sidebar.php";?>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            <h1 class="h2">PEMBELIAN BARANG</h1>
  ...
  <!-- Isikan konten disini -->
          ...
          <button type="button" class="btn btn-outline-primary " 
            data-toggle="modal" data-target="#modaltambah" >
             <img src="glyph-iconset-master/svg/si-glyph-document-plus.svg" style="height: 25px;" />PEMBELIAN BARU
           </button>
          <button type="button" class="btn btn-outline-primary " 
            >
             <img src="#" style="height: 25px;" />TAMPIL PEMBELIAN
  ...
  <?php 
     include "transaksi_pembelian_tambah.php";
  ?>
