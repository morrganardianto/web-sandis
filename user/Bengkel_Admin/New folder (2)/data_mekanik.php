...
<?php include "navigasi.php";
  ...
  <?php 
 include "data_mekanik_tambah.php";
  ?>
...
<?php
  ...
  ?>
      ...
      <td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalubah<?php echo $row['id_mk']; ?>">Ubah</button></td>
      <td><button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#modalhapus<?php echo $row['id_mk']; ?>">Hapus</button></td>
    </tr>
  <?php
