    ...
    <div class="modal-body">
        <div class="form-group row" style="display: none"> style="display: none"
         ...
         <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="hargajual_brg" placeholder="Harga Jual">
            <input type="text" class="form-control" name="harga_barang" placeholder="Harga Beli">
        </div>
       </div>
