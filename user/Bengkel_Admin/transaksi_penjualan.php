...
<?php include "navigasi.php";
  ...
  <!-- Isikan konten disini -->
          ...
          <button type="button" class="btn btn-outline-primary " 
            data-toggle="modal" data-target="#modaltambah" >
             <img src="glyph-iconset-master/svg/si-glyph-document-plus.svg" style="height: 25px;" />PENJUALAN BARU
           </button>
          <button type="button" class="btn btn-outline-primary " 
            >
             <img src="#" style="height: 25px;" />TAMPIL PENJUALAN
  ...
  <?php 
     include "transaksi_penjualan_tambah.php";
  ?>
